...
export const metadata = {
    title: 'Privacy Policy for Easy Canonical Links'
};
...
- **Shop Information**: We collect data about your Shopify store, such as your store name, domain, and Shopify store ID. This information is necessary to provide you with our services through **Easy Canonical Links**.
...
- Providing and improving the **Easy Canonical Links** app and its services.
...
- We may share data with trusted third-party services (e.g., cloud services) necessary for running **Easy Canonical Links**.
- We implement secure protocols to protect your data.

### Your Rights
You have the right to:
- Access, update, or delete your data.
- Contact us to learn more about how your data is being used within **Easy Canonical Links**.
...
### Contact Us
If you have any questions about this Privacy Policy or how **Easy Canonical Links** handles your data, you can contact us at:
...
export default async function Page() {
    return (
        <>
            <h1>Privacy Policy for Easy Canonical Links</h1>
